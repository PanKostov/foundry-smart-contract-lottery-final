 ...
 * @dev Implements Chainlink VRVv2.5
 */
...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    error Raffle__UpkeepNotNeeded(uint256 balance, uint256 playersLenght, RaffleState raffleState);
     ...
     * Will automatically be called by chainlink if checkUpkeep passes
     */
    function performUpkeep() external {
        // The time between NOW minus the last call of pickWinner, should be bigger than i_interval
